...
public class Chapter5 {
	public static void main(String[] args) throws Exception {
		...
		sparkReport.loadJSONConfig(new File("./src/test/resources/extent_report.json"));
		...
		extentReports.createTest("Test7", "The double Test").assignAuthor(new String[] {"swamy","saranam","Ayyappa"})
		.assignCategory(new String[] {"smoke","sanity","regression"}).assignDevice(new String[] {"edge99","chrome99","Edge102"});
